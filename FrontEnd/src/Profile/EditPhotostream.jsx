...
const EditPhotostream = () => {
  ...
  useEffect(() => {
    axios.get(`/Photostream/${id}`, {})
      .then((resp) => {
        setIsLoading(false);
        setPhotos(resp.data.photoArray);
    ...
    <div className="edit-photolist-container-euph">
      ...
      <div>
        <div className="edit-toolbar-euph">
          <Link to={`/Profile/Photostream/${id}`} className="back-edit-euph">
        ...
        <div className="photolist-view-edit-euph">
          {photoArr.map((image) => (
            <div className="grid-item-euph" style={{ backgroundImage: `url(${image.imagePath})`, minHeight: '402px', transform: `translate(${translateW}, ${translateH})` }}>
              {handleChangeVal}
              ...
              <div className="interaction-view-euph">
                <div className="photo-interaction-edit-euph">
                  <Link className="overlay-direct-photo-euph" to={image.imagePath} />
                  ...
                  <div className="interaction-bar-euph" id="editable-area-euph">
                    <div className="image-bar-euph">
                      <div className="title-desc-block-euph">
                        ...
                        <EditTextarea name="desc-textarea-euph" style={{ borderColor: '#209be3' }} defaultValue="Add description" value={image.description} className="desc-text-euph" />
                      </div>
                    </div>
