...
* @apiError (Error 408) {String} error the server would like to shut down this unused connection. It is sent on an idle connection by some servers, even without any previous request by the client.
* @apiError (Error 408) {Number} statusCode The status code
* @apiError (Error 429) {String} error the user has sent too many requests in a given amount of time ("rate limiting").
