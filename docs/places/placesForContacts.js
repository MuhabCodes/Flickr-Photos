/**
 * 
 * @api {get} /places/placesForContacts placesForContacts
 * @apiName places
 * @apiGroup places
 * @apiVersion  1.0.0
 * 
 * @apiDescription Return a list of the top 100 unique places clustered by a given placetype for a user's contacts.
 * 
 * 
...
* @apiParam  {String} [contacts] Search your contacts. Either 'all' or 'ff' for just friends and family. (Default is all)
